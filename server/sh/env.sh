...
export MONGODB_URL="mongodb+srv://minhchiu:minhchiu@cluster0.8r8ak.mongodb.net/proshop?retryWrites=true&w=majority"
...
# JWT expirations
export JWT_ACCESS_EXPIRATION=4days
export JWT_REFRESH_EXPIRATION=7days
